        ...
        <div style={{ background: 'var(--bg-card)', border: '1px solid var(--border)', borderRadius: 10, padding: 20, marginBottom: 16 }}>
          ...
          <div className="g-3" style={{ gap: 12 }}>
            {[
              ...
              <div key={title} style={{ padding: '14px 16px', background: 'var(--bg)', borderRadius: 8, borderTop: '2px solid #6366f1' }}>
                <div style={{ fontSize: 20, marginBottom: 8 }}>{icon}</div>
                <div style={{ fontSize: 13, fontWeight: 600, color: 'var(--text-h)', marginBottom: 6 }}>{title}</div>
        ...
        <div style={{ background: 'var(--bg-card)', border: '1px solid var(--border)', borderRadius: 10, padding: 20 }}>
          <ResponsiveContainer width="100%" height={260}>
            <BarChart data={winRateByDTE} barCategoryGap="30%">
              <CartesianGrid {...CHART_STYLE.cartesianGrid} />
              <XAxis dataKey="dte" {...CHART_STYLE.xAxis} label={{ value: 'Entry DTE', position: 'insideBottom', offset: -4, fill: 'var(--text-muted)', fontSize: 11 }} height={40} />
        ...
        <div style={{ background: 'var(--bg-card)', border: '1px solid var(--border)', borderRadius: 10, padding: 20 }}>
          <ResponsiveContainer width="100%" height={240}>
            <BarChart data={pnlBuckets} barCategoryGap="20%">
              <CartesianGrid {...CHART_STYLE.cartesianGrid} />
              <XAxis dataKey="bucket" {...CHART_STYLE.xAxis} tick={{ fill: 'var(--text-muted)', fontSize: 9 }} />
              <YAxis {...CHART_STYLE.yAxis} label={{ value: '# Trades', angle: -90, position: 'insideLeft', fill: 'var(--text-muted)', fontSize: 11 }} />
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
              ...
              <tbody>
                {[
                  ...
                  <tr key={rule} style={{ borderBottom: '1px solid var(--border)', background: rule.includes('✓') ? '#10b98108' : 'transparent' }}>
                    <td style={{ padding: '10px 14px', color: rule.includes('✓') ? '#10b981' : 'var(--text-h)', fontWeight: rule.includes('✓') ? 600 : 400 }}>{rule}</td>
                    <td style={{ padding: '10px 14px', color: 'var(--text)', fontFamily: 'monospace' }}>{wr}</td>
                    <td style={{ padding: '10px 14px', color: 'var(--text)', fontFamily: 'monospace' }}>{avg}</td>
      ...
      <section style={{ marginBottom: 40 }}>
        ...
        <div className="g-2" style={{ gap: 16 }}>
          {[
            ...
            <div key={step} style={{ background: 'var(--bg-card)', border: '1px solid var(--border)', borderRadius: 10, padding: '16px 20px' }}>
