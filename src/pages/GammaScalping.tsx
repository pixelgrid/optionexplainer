        ...
        <div style={{ background: '#1a1d27', border: '1px solid #2a2d3e', borderRadius: 10, padding: 20 }}>
          <ResponsiveContainer width="100%" height={260}>
            <LineChart data={gammaPnlData}>
              ...
              <XAxis dataKey="move" {...CHART_STYLE.xAxis} label={{ value: 'Stock Move ($)', position: 'insideBottom', offset: -4, fill: '#64748b', fontSize: 11 }} height={40} />
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
              ...
              <tbody>
                {rehedgeData.map(({ freq, grossPnl, slippage, netPnl, sharpe }) => (
                  <tr key={freq} style={{ borderBottom: '1px solid #1e2130', background: freq === 'Every $2' ? '#10b98108' : 'transparent' }}>
                    <td style={{ padding: '10px 14px', color: freq === 'Every $2' ? '#10b981' : '#e2e8f0', fontWeight: freq === 'Every $2' ? 600 : 400 }}>{freq}</td>
                    ...
                    <td style={{ padding: '10px 14px', color: '#94a3b8', fontFamily: 'monospace', fontWeight: 600 }}>${netPnl}</td>
        ...
        <div style={{ background: '#1a1d27', border: '1px solid #2a2d3e', borderRadius: 10, padding: 20 }}>
          ...
          <div className="g-3" style={{ gap: 12 }}>
            {[
              ...
              <div key={component} style={{ padding: '14px 16px', background: '#0f1117', borderRadius: 8, borderTop: `2px solid ${color}` }}>
                <div style={{ fontSize: 12, fontWeight: 700, color, marginBottom: 4 }}>{component}</div>
                <div style={{ fontFamily: 'monospace', fontSize: 18, color: '#e2e8f0', fontWeight: 700, marginBottom: 2 }}>{ret}</div>
          ...
          <div style={{ marginTop: 16, padding: '12px 16px', background: '#6366f110', border: '1px solid #6366f130', borderRadius: 8, fontSize: 13, color: '#94a3b8' }}>
